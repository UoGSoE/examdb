...
Vue.component('course-archives-viewer', require('./components/CourseArchivesViewer.vue').default);
Vue.component('paper-list', require('./components/PaperList.vue').default);
Vue.component('archived-paper-list', require('./components/ArchivedPaperList.vue').default);
...
Vue.component('export-checklists-button', require('./components/ExportChecklistsButton.vue').default);
