...
class IncompletePaperworkNotificationTest extends TestCase
{
    ...
    /** @test */
    public function setters_are_notified_about_any_incomplete_resit_papers_after_the_deadline()
    {
        Mail::fake();
        $this->withoutExceptionHandling();
        // set the deadline to yesterday
    ...
    /** @test */
    public function setters_are_not_notified_about_resit_papers_which_are_fully_set()
    {
        Mail::fake();
        $this->withoutExceptionHandling();
        // set the deadline to yesterday
